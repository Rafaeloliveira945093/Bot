...
from handlers.message_handlers import (
    ...
    receber_link, comando_pronto, handle_any_message
)
...
(MENU_ENVIO, RECEBER_MIDIA, RECEBER_TEXTO, RECEBER_BOTOES, 
 ...
 RECEBER_LINK, CONFIRMAR_REPASSAR, EDITAR_REPASSAR) = range(11)
...
def main():
    ...
    envio_conversation = ConversationHandler(
        entry_points=[CallbackQueryHandler(button_handler, pattern="^opcao[1-5]$")],
        states={
    ...
    # Handle any other message (fallback to start menu)
